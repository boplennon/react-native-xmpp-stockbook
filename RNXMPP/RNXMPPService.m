...
-(void)querryLastArchivedMessages:(NSInteger)limit with:(NSString *)user before:(NSString *) before {
    XMPPResultSet *setFilter = [[XMPPResultSet alloc] initWithMax:limit before:before];
    ...
    [xElement addChild:[XMPPMessageArchiveManagement fieldWithVar:@"with" type:nil andValue:user]];
    [queryElement addChild:xElement];
     [queryElement addChild:setFilter];
